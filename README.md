...
#### 3.4.1 I'm using NCTH and cannot seem to hit anything!
TODO
...
<!-- #### 3.7.1 What about BSD?
1.13 is not supported on BSD. If you want to play regular Jagged Alliance 2, you can use [Jagged Alliance 2 Stracciatella](https://ja2-stracciatella.github.io/). -->
...
<!-- If you spot any incorrect/outdated info or a dead link, you can ~~message tais or Yunotchi~~ fix it yourself. -->